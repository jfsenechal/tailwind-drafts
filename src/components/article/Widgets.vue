...
<script setup>
const items = [
  { id: 1, "title": "Le journal de l'école", "texte": "Il sera bientôt disponible sur le site", "img": "newspaper.jpg", "url": "#" },
  { id: 2, "title": "La photo de la semaine", "texte": "Depuis le début de la semaine, nous pouvons assister aux présentations des chefs-d’oeuvre (P6)", "img": "camera1.jpg", "url": "#" },
