<template>
  <TransitionRoot :show="openSearch" as="template" @after-leave="query = ''" appear>
    <Dialog as="div" class="relative z-10" @close="emit('search-event', false)">
      <TransitionChild as="template" enter="ease-out duration-300" enter-fro.m="opacity-0" enter-to="opacity-100" leave="ease-in duration-200" leave-from="opacity-100" leave-to="opacity-0">
