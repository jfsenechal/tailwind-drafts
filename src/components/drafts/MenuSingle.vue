...
<template>
  <div class="flex items-center justify-center p-8">
    <Popover
      class="relative border-transparent text-gray-500 hover:border-orange hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"
      v-slot="{ open }">
      <PopoverButton
