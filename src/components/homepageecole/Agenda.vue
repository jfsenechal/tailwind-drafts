<template>
  <div class="pt-4 pb-5 lg:pt-4 lg:pb-5">
...
const events = [
  ...
  {
    id: 3,
    name: "Présentation du chef d'oeuvre",
    description: "Par Nisou",
    href: "#",
    year: "2022",
    month: "06",
    day: "15"
  ...
  {
    id: 4,
    name: "Conseil d'école participatif",
    description: "17h30",
    href: "#",
    year: "2022",
    month: "06",
  ...
  {
    id: 7,
    name: "Classes de dépaysement à Dalhem",
    description: "(P3-P4)",
    href: "#",
    year: "2022",
    month: "07",
  ...
  },
  {
    ...
    description: "Déjeuner pour les parents",
    href: "#",
    year: "2022",
    month: "09",
    day: "01"
